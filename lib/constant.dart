...
const NetworkImage pc = NetworkImage('https://res.cloudinary.com/dqiwrcosz/image/upload/v1693706534/pc_kksp4q.png');
const NetworkImage monitor = NetworkImage('https://res.cloudinary.com/dqiwrcosz/image/upload/v1693706640/monitor_wsusvi.png');
const NetworkImage tablet = NetworkImage('https://res.cloudinary.com/dqiwrcosz/image/upload/v1693705764/tablet_zjxxfi.png');
const NetworkImage telf = NetworkImage('https://res.cloudinary.com/dqiwrcosz/image/upload/v1693707962/teldf_wknfqc.png');
const NetworkImage satelite = NetworkImage('https://res.cloudinary.com/dqiwrcosz/image/upload/v1693708131/satellite_vyiytt.png');
